...
var getPlaceholder = function getPlaceholder(_ref2) {
  ...
  if (metadata === null || metadata === void 0 ? void 0 : metadata.props.placeholder) return metadata === null || metadata === void 0 ? void 0 : metadata.props.placeholder;

  if (typeof (metadata === null || metadata === void 0 ? void 0 : metadata.type) === 'function' && ['select', 'Select'].includes(metadata === null || metadata === void 0 ? void 0 : (_metadata$type = metadata.type) === null || _metadata$type === void 0 ? void 0 : _metadata$type.name)) {
...
var InternalFormItem = function InternalFormItem(props) {
  ...
  return /*#__PURE__*/React.createElement(Form.Item, _objectSpread(_objectSpread({
    label: label,
    required: isRequired,
    ...
    style: style
  }), /*#__PURE__*/React.cloneElement(props.children, _objectSpread(_objectSpread({}, field), {}, {
